...
//        .package(url: "https://github.com/facebook/facebook-ios-sdk", exact: "6.9.0")
    ],
    targets: [
        ...
        .binaryTarget(name: "BlueStackSASAdapter", path: "BlueStackSDK/BlueStackSASAdapter.xcframework"),
    ]
)
